...
public class Ast {
    ...
    public static class DefFunction extends Expression {
        ...
        public DefFunction(String name, List<Argument> arguments, Type returnType, Block body) {
            this.name = name;
    ...
    public static class Factory {
         ...
         */
        public static DefFunction tDef(String name, List<Argument> args, Type returntType, Block body) {
            return new DefFunction(name, args, returntType, body);
        }
